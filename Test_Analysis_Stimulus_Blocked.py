...
# df_total from Day1
df_total = pd.read_csv('D://OneDrive - UGent//Desktop//Mina//Prolific//4.Stimulus_Oriented_Blocked_two_days//Day1//Data//df_total_Stimulus_Blocked_Day1.csv')
...
csv_list=['5a4afbfdf7b7bc00014e157a.csv','5a8b3fa3b093f80001a80576.csv','5a94ca1a873cda0001dc7147.csv',
          '5b3e2334cdb4ce0001d93c51.csv','5b9ec956c8a17f000171f7ad.csv','5be76781f6d13b0001cf5257.csv',
          '5c93e410ec114b001641a170.csv','5cfb5233df7d70001619ca90.csv','5d4b265b72db9d0015e8aac6.csv',
          '5e00fbbf5777b5cea2d27c6a.csv','5e09ffd8fa3d102a583771c1.csv','5e28c4b59f0de509e0322c85.csv',
          '5ea11734166d231259527b6e.csv','5ee5f4fb232e9d341d0751b8.csv','5f4d3cb5fdda0b2c403fb801.csv',
          '5f8a1fcf2773900d456a3e70.csv','5f342a35aea7432daf29219d.csv','5f1091aa4bd173363a9700ec.csv',
          '5f3227893ca51916b4ff6d9d.csv','5fe3f539dd8cf10e7d545231.csv','5fecaa563803bbe5ddd072b7.csv',
          '58ae59babb9e0f0001acb414.csv','60fd080d5476f4a77211bafb.csv','60fed38a8adb46e44e0869a5.csv',
          '60ff4ce700aa0457fadbc736.csv','62a378da05bc514b69023189.csv','62b4ef82055cec7135502ada.csv',
          '62f17b6b63bd9e6627a19956.csv','600b4cdb45d6e41cbaa79e33.csv','608f2aa883599160c8b87a79.csv',
          '610f88a0347fcfab1d1fdc03.csv','614e36c5f5569f7b6d406171.csv','616ca5967d36f0000bd47b78.csv',
          '628e24c80b3e2b2e0d7a5af1.csv','628f9ef985fa6d3dc816672c.csv','633e14bdd205bc78a12e3f97.csv',
          '6000cefee380e61fa9bc5ae4.csv','6090b3f525cbbdcb540e6bbd.csv','6101f6f45269e30a22fc4526.csv',
          '6137e7902deee6112b009008.csv','6234c1abfc04a4163c09a78f.csv','6321d7404a95a42175d1243d.csv',
          '60873d2ab16643e5a08cafd2.csv','63059d9f1e8b92556548c50a.csv','559385f5fdf99b78e49c58e9.csv',
          '607134f478e13587bd89e13a.csv','610024bfd6e1038ba3b1601d.csv','627892b9d1e41df8b9679538.csv',
          '631752de5476b145e0f6075c.csv','6100434d983910e711b3a504.csv','61144425f2d21408212bbbed.csv',
          '62851102d56842a48361f9d4.csv','610898813e48dc2864965122.csv','615366914bfb3d9509710cba.csv',
          '6333813956b0fd924b64a4d0.csv','628c2454c8c66010dd87391d.csv']
...
address='D://OneDrive - UGent//Desktop//Mina//Prolific//4.Stimulus_Oriented_Blocked_two_days//Day2//Data//'
####################################################################################################################
##################################################################################################################
...
df_payment_Day2.to_csv(address+'df_payment_Stimulus_Blocked_Day2.csv', index=False)
...
df_Stimulu_Response.to_csv(day_2_add+'df_SR_StimulusBlocked.csv', index=False) 
...
y_acc = [df_Stimulu_Response['SR_1_ACC'].mean(), df_Stimulu_Response['SR_2_ACC'].mean(), df_Stimulu_Response['SR_3_ACC'].mean(), 
        df_Stimulu_Response['SR_4_ACC'].mean(), df_Stimulu_Response['SR_5_ACC'].mean(), df_Stimulu_Response['SR_6_ACC'].mean(),
        df_Stimulu_Response['SR_7_ACC'].mean(), df_Stimulu_Response['SR_8_ACC'].mean(), df_Stimulu_Response['SR_9_ACC'].mean(),
        df_Stimulu_Response['SR_10_ACC'].mean(), df_Stimulu_Response['SR_11_ACC'].mean(), df_Stimulu_Response['SR_12_ACC'].mean()]

y_rt = [df_Stimulu_Response['SR_1_RT'].mean(), df_Stimulu_Response['SR_2_RT'].mean(), df_Stimulu_Response['SR_3_RT'].mean(), 
       df_Stimulu_Response['SR_4_RT'].mean(), df_Stimulu_Response['SR_5_RT'].mean(), df_Stimulu_Response['SR_6_RT'].mean(),
       df_Stimulu_Response['SR_7_RT'].mean(), df_Stimulu_Response['SR_8_RT'].mean(), df_Stimulu_Response['SR_9_RT'].mean(),
       df_Stimulu_Response['SR_10_RT'].mean(), df_Stimulu_Response['SR_11_RT'].mean(), df_Stimulu_Response['SR_12_RT'].mean()]

y_leg_acc= [df_Stimulu_Response['SR_1_ACC_leg'].mean(), df_Stimulu_Response['SR_2_ACC_leg'].mean(), df_Stimulu_Response['SR_3_ACC_leg'].mean(), 
            df_Stimulu_Response['SR_4_ACC_leg'].mean(), df_Stimulu_Response['SR_5_ACC_leg'].mean(), df_Stimulu_Response['SR_6_ACC_leg'].mean(),
            df_Stimulu_Response['SR_7_ACC_leg'].mean(), df_Stimulu_Response['SR_8_ACC_leg'].mean(), df_Stimulu_Response['SR_9_ACC_leg'].mean(),
            df_Stimulu_Response['SR_10_ACC_leg'].mean(), df_Stimulu_Response['SR_11_ACC_leg'].mean(), df_Stimulu_Response['SR_12_ACC_leg'].mean()]

y_leg_rt= [df_Stimulu_Response['SR_1_RT_leg'].mean(), df_Stimulu_Response['SR_2_RT_leg'].mean(), df_Stimulu_Response['SR_3_RT_leg'].mean(), 
           df_Stimulu_Response['SR_4_RT_leg'].mean(), df_Stimulu_Response['SR_5_RT_leg'].mean(), df_Stimulu_Response['SR_6_RT_leg'].mean(),
           df_Stimulu_Response['SR_7_RT_leg'].mean(), df_Stimulu_Response['SR_8_RT_leg'].mean(), df_Stimulu_Response['SR_9_RT_leg'].mean(),
           df_Stimulu_Response['SR_10_RT_leg'].mean(), df_Stimulu_Response['SR_11_RT_leg'].mean(), df_Stimulu_Response['SR_12_RT_leg'].mean()]

y_antenn_acc= [df_Stimulu_Response['SR_1_ACC_antenn'].mean(), df_Stimulu_Response['SR_2_ACC_antenn'].mean(), df_Stimulu_Response['SR_3_ACC_antenn'].mean(), 
               df_Stimulu_Response['SR_4_ACC_antenn'].mean(), df_Stimulu_Response['SR_5_ACC_antenn'].mean(), df_Stimulu_Response['SR_6_ACC_antenn'].mean(),
               df_Stimulu_Response['SR_7_ACC_antenn'].mean(), df_Stimulu_Response['SR_8_ACC_antenn'].mean(), df_Stimulu_Response['SR_9_ACC_antenn'].mean(),
               df_Stimulu_Response['SR_10_ACC_antenn'].mean(), df_Stimulu_Response['SR_11_ACC_antenn'].mean(), df_Stimulu_Response['SR_12_ACC_antenn'].mean()]

y_antenn_rt= [df_Stimulu_Response['SR_1_RT_antenn'].mean(), df_Stimulu_Response['SR_2_RT_antenn'].mean(), df_Stimulu_Response['SR_3_RT_antenn'].mean(), 
              df_Stimulu_Response['SR_4_RT_antenn'].mean(), df_Stimulu_Response['SR_5_RT_antenn'].mean(), df_Stimulu_Response['SR_6_RT_antenn'].mean(),
              df_Stimulu_Response['SR_7_RT_antenn'].mean(), df_Stimulu_Response['SR_8_RT_antenn'].mean(), df_Stimulu_Response['SR_9_RT_antenn'].mean(),
              df_Stimulu_Response['SR_10_RT_antenn'].mean(), df_Stimulu_Response['SR_11_RT_antenn'].mean(), df_Stimulu_Response['SR_12_RT_antenn'].mean()]

y_mouth_acc= [df_Stimulu_Response['SR_1_ACC_mouth'].mean(), df_Stimulu_Response['SR_2_ACC_mouth'].mean(), df_Stimulu_Response['SR_3_ACC_mouth'].mean(), 
              df_Stimulu_Response['SR_4_ACC_mouth'].mean(), df_Stimulu_Response['SR_5_ACC_mouth'].mean(), df_Stimulu_Response['SR_6_ACC_mouth'].mean(),
              df_Stimulu_Response['SR_7_ACC_mouth'].mean(), df_Stimulu_Response['SR_8_ACC_mouth'].mean(), df_Stimulu_Response['SR_9_ACC_mouth'].mean(),
              df_Stimulu_Response['SR_10_ACC_mouth'].mean(), df_Stimulu_Response['SR_11_ACC_mouth'].mean(), df_Stimulu_Response['SR_12_ACC_mouth'].mean()]

y_mouth_rt= [df_Stimulu_Response['SR_1_RT_mouth'].mean(), df_Stimulu_Response['SR_2_RT_mouth'].mean(), df_Stimulu_Response['SR_3_RT_mouth'].mean(), 
             df_Stimulu_Response['SR_4_RT_mouth'].mean(), df_Stimulu_Response['SR_5_RT_mouth'].mean(), df_Stimulu_Response['SR_6_RT_mouth'].mean(),
             df_Stimulu_Response['SR_7_RT_mouth'].mean(), df_Stimulu_Response['SR_8_RT_mouth'].mean(), df_Stimulu_Response['SR_9_RT_mouth'].mean(),
             df_Stimulu_Response['SR_10_RT_mouth'].mean(), df_Stimulu_Response['SR_11_RT_mouth'].mean(), df_Stimulu_Response['SR_12_RT_mouth'].mean()]
...
Day_1_Address = 'D://OneDrive - UGent//Desktop//Mina//Prolific//4.Stimulus_Oriented_Blocked_two_days//Day1//Data//'
...
#########Here###########
    ...
    df_train.to_csv(address+'df_train_'+ str(j) +'_Stimulus_Blocked_labesl_Day1.csv', index=False)
    df_test.to_csv(address+'df_'+ str(j) +'_Stimulus_Blocked_Labels_Day2.csv', index=False)
##########################################################################################
...
for i in range (len(list_csv_file_Day2_Update)):
    list_csv_file_df_test.append('df_'+ str(i) +'_Stimulus_Blocked_Day2.csv')
...
df_total_test.to_csv(address+'df_total_Stimulus_Blocked_Day2.csv', index=False)
...
df_total.to_csv(address+'df_Total_Stimulus_Blocked_Two_Days_Required_Payment.csv', index=False)
...
df_total = pd.read_csv(address+'df_Total_Stimulus_Blocked_Two_Days_Required_Payment.csv')
...
df_whole_train.to_csv(address+'df_Total_Stimulus_Blocked_Two_Days_ACC_Critera_Whole_Train.csv', index=False)
...
df_switch_cost.to_csv(address+'df_Switch_Cost_Stimulus_Blocked_Labels.csv', index=False)
         
df_456.to_csv(address+'df_Total_Stimulus_Blocked_Two_Days_ACC_Critera_456_Train.csv', index=False)
...
with open(address+"SB_Labeling_mean_acc_tasks.csv", "w", newline="") as fp:
...
df_outlier.to_csv(address+'df_Total_Stimulus_Blocked_Two_Days_without_outlier.csv', index=False)
...
df_456=pd.read_csv('D://OneDrive - UGent//Desktop//Mina//Prolific//4.Stimulus_Oriented_Blocked_two_days//Day2//Data//df_Total_Stimulus_Blocked_Two_Days_ACC_Critera_456_Train.csv')
...
df_bar.to_csv(address+'df_bar_Stimulus_Blocked.csv', index=False)
...
plt.title("Stimulus_Blocked (ACC Criteria Whole Training)",fontsize=12)
plt.xlabel('Block') 
plt.ylabel('Mean ACC')
plt.xticks(rotation=45)
plt.ylim(0.5, 1)
...
plt.xticks(rotation=45)
plt.title("Mean ACC Stimulus_Blocked Task",fontsize=20)
plt.xlabel('Block') 
plt.ylabel('Mean ACC')
plt.ylim(0.5, 1)
...
plt.xticks(rotation=45)
plt.title("Mean RT Stimulu_Blocked Task",fontsize=20)
plt.xlabel('Block') 
plt.ylabel('Mean RT')
plt.ylim([700, 2000])
