...
# df_total from Day1
df_total = pd.read_csv('D://OneDrive - UGent//Desktop//Mina//Prolific//5.Stimulus_Oriented_Blocked_New_Version_Two_Days//Day1//df_total_Stimulus_Blocked_New_Version_Day1.csv')
...
csv_list=['60ff61f892600d5d9c7a9ce5.csv','5e8d44819163b611f62d706c.csv','5dbbfa90c486791b1bd03292.csv',
          '5f98fd9bc1d2852287281bdb.csv','610b164074738771ef9acb0a.csv','631636ea6359694a5ae0be31.csv',
          '5a6fd0626923df0001ef977b.csv','5ed8cf4782a6eb04ddf9962d.csv','5d96eeed1998fb00177f6b71.csv',
          '5e68b753e203811578c0a521.csv','5e6685e1ffed4c405a4db5d0.csv','5dcf932f3708100b7db43ddd.csv',
          '5e45a7e926e79c000bc12a85.csv','5c27de12a2b00a00018b2c16.csv','5e82a76d09f66f9cd3aeb0e7.csv',
          '601e13b872774f263d64acac.csv','5ea9fd35de1f1015aea1117a.csv','611ab91a00baa062f55b86d8.csv',
          '63162e1bbde3c4bb1d9d92a3.csv','5658000ca9872d0011e1ba26.csv','62bdad093f129a724c4dd7b2.csv',
          '60e797b64fca2922f9cd51af.csv','594a964c215cbd000146de75.csv','6305b8d5ac4df0bfd1e5b335.csv',
          '5f6e36c7f042f033d0f97bc1.csv','61010400617800821cac834e.csv','60fced51e14f51249023972a,csv',
          '5c2dea19d396500001e2b39d.csv','6318f71ece2f523f840e1eee.csv','6109d15f510e56947f3f1bae.csv',
          '62b33f729b02ed15713cb73b.csv','56f59251736c79000c2241f7.csv','5c6fb7c3c114eb00018b3154.csv',
          '603862f99e00971c55fe0874.csv','5f0fab5abdec9a1aff2b2744.csv','5f0a5a99dbbf721316f118e2.csv',
          '5fa4f94e535f3b1aa628e0ab.csv','6101930ddd5330f83b898c61.csv','5a04869ff2e3460001edad2e.csv',
          '606537639bc40e88e953c584.csv','5e27868c5cbbcc0b3599574b.csv','5a78e410ae9a0b0001a97274.csv',
          '6317fe392a884cc045a9eb2b.csv','5c1942e200849900010afdcd.csv','62a733deec84f43ab19f7cca.csv',
          '6337cba5cbed8cb3514a6504.csv','60fced51e14f51249023972a.csv','5e9749b44592572013c96868.csv',
          '62911ef14fd68295d60ba83b.csv','61506f90721dcdeca6e77c2d.csv','5f569e71ae1bf40eae8b5e28.csv',
          '63474e67a5fd298c6103c409.csv','63254db937c17e8e9200fd54.csv','62bdc30224534809032cf056.csv',
          '61452bbe86c21c0347085911.csv','5e8b89d0afcb1606e761ef7f.csv','616c4a95398b06c2c85b32ed.csv',
          '5ee232f2b970662cfa352567.csv','5dee72917309b950e5262f3a.csv','631c8e97db06f601f81bd82f.csv',
          '5b5c8d4e10aec90001ed4bee.csv']
...
address='D://OneDrive - UGent//Desktop//Mina//Prolific//5.Stimulus_Oriented_Blocked_New_Version_Two_Days//Day2//'
####################################################################################################################
##################################################################################################################
...
df_payment_Day2.to_csv(address+'df_payment_Stimulus_Blocked_New_Version_Day2.csv', index=False)
...
# Address day1:
Day_1_Address= address = 'D://OneDrive - UGent//Desktop//Mina//Prolific//5.Stimulus_Oriented_Blocked_New_Version_Two_Days//Day1//'
...
SBN_Stimulu_Response = pd.DataFrame(columns = rule_Stimulus)
...
for j in range(len(list_csv_file_Day2_Update)):
    ...
    SBN_Stimulu_Response = SBN_Stimulu_Response.append(pd.DataFrame(acc_total, columns = rule_Stimulus), ignore_index=True)
    

SBN_Stimulu_Response['prolificID']=list_csv_file_Day2_Update
day_2_add='D://OneDrive - UGent//Desktop//Mina//Prolific//5.Stimulus_Oriented_Blocked_New_Version_Two_Days//Day2//'
SBN_Stimulu_Response.to_csv(day_2_add+'df_SR_StimulusBlockedNewVersion.csv', index=False) 
...
plt.clf()
plt.plot(x_axis, SBN_y_mouth_acc,'bo-')
plt.xticks(rotation=45)
plt.title("Stimulus_Blocked Planet (Stimulus_Response ACC Mouth Rule)",fontsize=12)
plt.xlabel('Block') 
plt.ylabel('Mean ACC')
plt.ylim(0.3, 1)

for x,y in zip(x_axis, SBN_y_mouth_acc):
...
plt.clf()
plt.plot(x_axis, SBN_y_mouth_rt,'bo-')
plt.xticks(rotation=45)
plt.title("Stimulu_Blocked Planet (Stimulus_Response RT Mouth Rule)",fontsize=12)
plt.xlabel('Block') 
plt.ylabel('Mean RT')
plt.ylim([700, 2000])
for x,y in zip(x_axis, SBN_y_mouth_rt):
...
Day_1_Address = 'D://OneDrive - UGent//Desktop//Mina//Prolific//5.Stimulus_Oriented_Blocked_New_Version_Two_Days//Day1//'
...
#########Here###########
    ...
    df_train.to_csv(address+'df_train_'+ str(j) +'_Stimulus_Blocked_Planet_Day1.csv', index=False)
    df_test.to_csv(address+'df_'+ str(j) +'_Stimulus_Blocked_Planet_Day2.csv', index=False)
##########################################################################################
...
for i in range (len(list_csv_file_Day2_Update)):
    list_csv_file_df_test.append('df_'+ str(i) +'_Stimulus_Blocked_New_Version_Day2.csv')
...
df_total_test.to_csv(address+'df_total_Stimulus_Blocked_New_Version_Day2.csv', index=False)
...
df_total.to_csv(address+'df_Total_Stimulus_Blocked_New_Version_Two_Days_Required_Payment.csv', index=False)
...
df_total = pd.read_csv(address+'df_Total_Stimulus_Blocked_New_Version_Two_Days_Required_Payment.csv')
...
Address_Day1='D://OneDrive - UGent//Desktop//Mina//Prolific//5.Stimulus_Oriented_Blocked_New_Version_Two_Days//Day1//'
...
df_whole_train.to_csv(address+'df_Total_Stimulus_Blocked_New_Version_Two_Days_ACC_Critera_Whole_Train.csv', index=False)
...
df_switch_cost.to_csv(address+'df_Switch_Cost_Stimulus_Blocked_New_Version.csv', index=False)
         
df_456.to_csv(address+'df_Total_Stimulus_Blocked_New_Version_Two_Days_ACC_Critera_456_Train.csv', index=False)
...
#='D://OneDrive - UGent//Desktop//Mina//Prolific//1.Context_Blocked_Two_Days//Day_2//Data//'
# Save CSV fiel to save the dictinary Open a csv file for writing
with open(address+"DAY2_SB_Planet_mean_acc_tasks.csv", "w", newline="") as fp:
...
df_outlier.to_csv(address+'df_Total_Stimulus_Blocked_New_Version_Two_Days_without_outlier.csv', index=False)
...
df_456=pd.read_csv('D://OneDrive - UGent//Desktop//Mina//Prolific//5.Stimulus_Oriented_Blocked_New_Version_Two_Days//Day2//df_Total_Stimulus_Blocked_New_Version_Two_Days_ACC_Critera_456_Train.csv')
...
df_bar.to_csv(address+'df_bar_Stimulus_Blocked_NewVersion.csv', index=False)
...
plt.title("Stimulus_Blocked New Version (ACC Criteria Whole Training)",fontsize=12)
plt.xlabel('Block') 
plt.ylabel('Mean ACC')
plt.xticks(rotation=45)
plt.ylim(0.5, 1)
...
plt.title("Mean Accuracy Stimulus_Blocked Planet",fontsize=20)
plt.xlabel('Block') 
plt.ylabel('Mean ACC')
plt.xticks(rotation=45)
plt.ylim(0.5, 1)
...
plt.title("Mean Reaction Time Stimulus_Blocked Planet",fontsize=20)
plt.xlabel('Block') 
plt.ylabel('Mean RT')
plt.xticks(rotation=45)
plt.ylim(0,2000)
...
plt.title("Stimulus_Blocked New Version (without outlier)",fontsize=12)
plt.xlabel('Block') 
plt.ylabel('Mean ACC')
plt.xticks(rotation=45)
plt.ylim(0.5, 1)
...
plt.title("Stimulus_Blocked New Version (Median)",fontsize=12)
plt.xlabel('Block') 
...
plt.xticks(rotation=45)
plt.title("Mean ACC Stimulus_Blocked Planet",fontsize=20)
plt.xlabel('Block') 
plt.ylabel('Mean ACC')
plt.ylim(0.5, 1)
...
plt.xticks(rotation=45)
plt.title("Stimulus_Blocked New Version (Whole)",fontsize=12)
plt.xlabel('Block') 
plt.ylabel('Mean RT')
plt.ylim([700, 2000])
...
plt.xticks(rotation=45)
plt.title("Mean RT Stimulus_Blocked Planet",fontsize=20)
plt.xlabel('Block') 
plt.ylabel('Mean RT')
plt.ylim([700, 2000])
...
import matplotlib.pyplot as plt
import pandas as pd
df_whole_train = pd.read_csv("D://OneDrive - UGent//Desktop//Mina//Prolific//5.Stimulus_Oriented_Blocked_New_Version_Two_Days//Day2//df_Total_Stimulus_Blocked_New_Version_Two_Days_ACC_Critera_Whole_Train.csv")
df_456= pd.read_csv("D://OneDrive - UGent//Desktop//Mina//Prolific//5.Stimulus_Oriented_Blocked_New_Version_Two_Days//Day2//df_Total_Stimulus_Blocked_New_Version_Two_Days_ACC_Critera_456_Train.csv")
